...
export function ConstituentHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-border/80 bg-white/90 shadow-sm shadow-primary/5 backdrop-blur-md">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6">
        ...
        <PrimaryButton href="/" size="lg" className="shrink-0 rounded-xl px-4 text-sm sm:px-5 sm:text-base">
